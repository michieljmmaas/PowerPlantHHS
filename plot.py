...
def plot(model_name, generation_number, load2=True):
    ...
    kW_distribution = simulator.calc_total_power(generation[0][0:-2], generation[0][-2])
    ...
    dic = calculatecost.get_stats(kW_distribution,319650,4,int(generation[0][-2]))
...
if __name__ == '__main__':
    consumption, kW_distribution, dic, generation = plot('20191106_120136', 99)
