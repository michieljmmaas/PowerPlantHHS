...
if __name__ == '__main__':
    ...
    calculatecost = CostCalculator(190, 400, 6000, 1000000, 1000)
    consumption, total_power, solar_power, wind_power, dic, configuration, max_power = plot(simulator, calculatecost, model_name='20191128_105309', generation_number=26)
    draw_Battery_Use(consumption, total_power, solar_power, wind_power, dic, configuration, max_power)
