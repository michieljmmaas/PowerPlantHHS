...
def train(n_generations, group_size, surface_min, surface_max, angle_min, angle_max, orientation_min, orientation_max,
          ...
          EnergyArray=None, cost_calculator=None, simulinkSettings=None, windturbineType=4, N_WIND_MAX=1000):
    """train genetic algorithm"""

    genetic_algorithm = GeneticAlgorith(mutationPercentage, 150, 6, 2, 2, True)
    cb_cost_table = pd.DataFrame({'area':[1.5, 2.5, 4, 6, 10, 16, 25, 35, 50, 70, 95, 120, 150, 185, 240, 300, 400, 600, 1000, 1250, 1600, 2000, 3000, 5000, 8000 , 10000, 12000, 15000, 18000, 22000, 25000, 30000, 40000, 50000, 60000, 70000, 80000, 90000, 100000],
        'cost':[0.002, 0.003, 0.008, 0.013, 0.014, 0.016, 0.025, 0.035, 0.075, 0.1, 0.15, 0.22, 0.3, 0.39, 0.49, 0.5, 0.62, 0.8, 1.25, 1.6, 2, 2.5, 3.5, 6, 9, 11, 13, 17.5, 20, 30, 40, 50, 60, 72, 84, 96, 110, 124, 140]})
...
if __name__ == '__main__':
    train(100, 100, 0, 10000000, 0, 90, 0, 359, model_name=None, load=False)
