...
def train(n_generations, group_size, surface_min, surface_max, angle_min, angle_max,
          orientation_min, orientation_max, model_name=None, load=False, counter=0, directory="", mutationPercentage=50, target_kw=6000):
    ...
    cost_calculator = CostCalculator(190, 25, target_kw, 1000000, cb_cost_table, 1000, 230)
