...
def HeaderRow(text1, text2, text3, text4, frameHolder, HFont):
    ...
    Label1 = Label(frameHolder, text=text1, width=InfoLabelWidth, height=InfoLabelHeight, anchor=W, relief=SOLID, font=HFont)
    Label2 = Label(frameHolder, text=text2, width=InfoLabelWidth, height=InfoLabelHeight, anchor=W, relief=SOLID, font=HFont)
    Label3 = Label(frameHolder, text=text3, width=InfoLabelWidth, height=InfoLabelHeight, anchor=W, relief=SOLID, font=HFont)
    Label4 = Label(frameHolder, text=text4, width=InfoLabelWidth, height=InfoLabelHeight, anchor=W, relief=SOLID, font=HFont)
...
def LabelRow(text, frameHolder, HFont, ColFont):
    ...
    Label1 = Label(frameHolder, text=text, width=InfoLabelWidth, height=InfoLabelHeight, anchor=W, relief=SOLID, font=HFont)
