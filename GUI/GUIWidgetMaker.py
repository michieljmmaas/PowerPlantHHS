...
def GrafiekButton(GUI, fileString, frameHolder, FramePlacer, function, arg):
    ButtonIcon = makeIcon(fileString,
                          frameHolder)  # Voordat je een plaatje kan toeveogen moet er eerst een Icon van zijn
    ...
    if not arg:
        RunButton = Button(FramePlacer, width=LabelWidth, height=LabelHeight, command=lambda: function(GUI, False),
                           relief=ButtonRelief,
